#ifndef BASICOFPROGRAMMING_STRING__H
#define BASICOFPROGRAMMING_STRING__H
...
/**возвращает указатель на первый символ, отличный от пробельных,
  начиная с begin и заканчивая ноль-символом, иначе возвращается адрес первого ноль-символа*/
